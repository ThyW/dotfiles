...
autocmd FileType rust <buffer> cnoremap:w :RustFmt <bar> :w <CR>
autocmd FileType rust <buffer> cnoremap:q :RustFmt <bar> :q <CR>
autocmd FileType rust <buffer> cnoremap:x :RustFmt <bar>:wq <CR>
