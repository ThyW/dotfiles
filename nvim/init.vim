...
autocmd FileType rust noremap <silent><F5> :sp<CR> :resize -20<CR> :!cargo run<CR> :q!<CR>
autocmd FileType rust noremap <silent><F6> :sp<CR> :resize -20<CR> :!cargo build<CR> :q!<CR>
