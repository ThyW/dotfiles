...
alias nvim='~/programming/git_clones/neovim/build/bin/nvim'
alias bconf='vim ~/.bashrc && ~/sync-config.sh && clear && source ~/.bashrc'
alias vc='PREVIOUS="$PWD" && cd ~/.config/nvim && vim ./ && ~/sync-config.sh && cd $PREVIOUS'
...
alias screencapture='ffmpeg -video_size 1920x1080 -framerate 30 -f x11grab -i :0.0+100,200 ~/Videos/recording.mp4'
