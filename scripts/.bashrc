...
alias vi='nvim'
alias bconf='vi ~/.bashrc && ~/sync-config.sh && clear && source ~/.bashrc'
alias vc=' vi ~/.config/nvim/init.vim && ~/sync-config.sh'
alias i3c='vi ~/.config/i3/config && ~/sync-config.sh'
alias sb='source ~/.bashrc'
alias ac='vi ~/.config/alacritty/alacritty.yml && ~/sync-config.sh'
...
alias rend='echo "require('rmarkdown'); render("$0")" | R --vanilla'
